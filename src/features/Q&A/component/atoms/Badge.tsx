 ...
 * ATOM: Badge
 * 
 * Rôle: Affiche une petite étiquette pour les catégories, tags, ou statuts.
 * Utilisé dans: Questions, Filtres, Statuts
 * 
 * Props:
 * - children: Contenu du badge
 * - variant: Style du badge ("primary", "secondary", "outline")
