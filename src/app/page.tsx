...
//           <Image
//             src="landing-page/image 12.svg" alt="background" width={1440} height={900}>
//           </Image>
//         </div>
...
//             FeedMe brings together home cooks, professional chefs, and local <br />restaurants in one place. Share recipes, discover neighborhood spots,
...
//             <div className="px-4 py-2 border-b-2 border-black hover:text-primary-500 ">
...
//               <h2 className="font-medium text-4xl hover:text-primary-500">
...
//             <Image src="landing-page/threepic.svg" alt="three pictures" width={737} height={462} className="">
//             </Image>
//           </div>
//         </div>
...
//           <Image src="landing-page/eat.svg" width={1312} height={957} alt="eat">
//           </Image>
//         </div>
//       </div>
//       {/* fourth-section */}
...
//           <div className="logo">
//             <Image src="FeedMe Orange.svg" width={30} height={30} alt='logo'></Image>
//           </div>
//           <div className="list">
//             <ul className="flex items-center gap-8 font-bold mx-8">
...
//               <li>
//                 <Image src="landing-page/whatsapp.svg" width={24} height={24} alt="whatsApp">
//                 </Image>
//               </li>
//               <li>
//                 <Image src="landing-page/snapchat.svg" width={24} height={24} alt="snapchat">
//                 </Image>
//               </li>
//               <li>
//                 <Image src="landing-page/facebook.svg" width={24} height={24} alt="facebook">
//                 </Image>
//               </li>
//               <li>
//                 <Image src="landing-page/instagram.svg" width={24} height={24} alt="insta">
//                 </Image>
//               </li>
//               <li>
//                 <Image src="landing-page/telegram.svg" width={24} height={24} alt="telegram">
//                 </Image>
//               </li>
//             </ul>
//           </div>
